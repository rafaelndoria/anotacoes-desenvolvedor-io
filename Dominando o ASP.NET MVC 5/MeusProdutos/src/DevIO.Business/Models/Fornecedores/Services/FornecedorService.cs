...
namespace DevIO.Business.Models.Fornecedores.Services
{
    public class FornecedorService : BaseService, IFornecedorService
    {
        ...
        {
            // Limitaçoes do EF, o Id do fornecedor tem que ser igual ao Id do endereco, para criar o relacionamento entre as tabelas
            ...
            if (await ExisteFornecedor(fornecedor))
                return;
